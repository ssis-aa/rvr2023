# https://github.com/emwdx/rvr_circuitpython/blob/main/sphero_rvr.py
import board
import busio
import struct
import time
...
class RVRDrive:
    ...
    # SOP   FLAG  TID   SID   DID   CID   SEQ   DATA
    # 0x8D, 0x3E, 0x11, 0x01, 0x1A, 0x1A, 0x00, 0x3F, 0xFF, 0xFF, 0xFF
